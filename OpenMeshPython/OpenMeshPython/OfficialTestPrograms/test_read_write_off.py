...
class ReadWriteOFF(unittest.TestCase):
    ...
    def test_read_write_read_MyModel(self):
        mesh1 = openmesh.read_trimesh("TestFiles/EightWithHole.off")
        openmesh.write_mesh('OutFiles/EightWithHoleOut.off', mesh1)
        mesh2 = openmesh.read_trimesh('OutFiles/EightWithHoleOut.off')
